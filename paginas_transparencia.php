	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2 col-xs-12  col-xs-offset-0 div_white" >
				<div class="row"><a href="#about"><img src="images/baner-header.jpg" class="img-responsive"/></a></div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-8 col-md-offset-2 col-xs-12  col-xs-offset-0 div_white" >
				<div class="menu-interno">
					<a href="index">Inicio</a> <span>></span> Transparencia
				</div>			
				<div id="elementos">
				</div>
			</div>
