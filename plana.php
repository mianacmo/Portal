		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2 col-xs-12  col-xs-offset-0 div_white" >
				<div class="menu-interno">
					<a href="index.php">Inicio</a> <span>></span> <a href="transparencia.php">Transparencia</a> <span>></span> <span id='titulo'>Plana</span>
				</div>			
				<div id="elementos">
				</div>
			</div>
