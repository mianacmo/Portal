    ...
    <div class="container">
		...
		<div class="row" style="margin-right: 0px;margin-left: 0px;" id="subir">
				<div class="col-lg-3 col-sm-4 col-izquierda" >
						<h3 id="titular_seccion">Políticas de privacidad</h3>
						<img src="images/9_politicadeprivacidad3.png" class="img-responsive"/>
							
						
				</div>
				<div class="col-lg-9 col-sm-8 div_white" >
									<div class="menu-interno">
											<a href="<?php echo $host?>index">Inicio</a> <span>></span> <a href="<?php echo $host?>politica-privacidad">Políticas de privacidad</a>													
									</div>																		
			...
			function cargarSeccionContenido(id,id2)
				{
					 	  ...
					 	  var parametros={selectfuncion:"cargar_seccion_contenido_id",valor:id,valor2:id2,valor3:"9"};
					  $.ajax({
								data:  parametros,
