...
?>
    <div class="container">
		...
		<div class="row" style="margin-right: 0px;margin-left: 0px;" id="subir">
				<div class="col-lg-3 col-sm-4 col-izquierda" >
						...
						<h3 id="titular_seccion">Subasta</h3>
						<img src="images/02_Subasta.png" class="img-responsive"/>
							
						
				</div>
				<div class="col-lg-9 col-sm-8 div_white" >
									</br>																			
									<h1 id="titular_subseccion">Relación de Subastas</h1>			
	...
	<script src="lightslider-master/src/js/lightslider.js"></script> 
	 ...
	 <script>
			document.title = "Subastas";
			cargar_subastas();
			function cargar_subastas()
				{
						
					 	var parametros={selectfuncion:"cargar_subastas"};
						$.ajax({
								data:  parametros,
